...
class PipeLineHead:
    ...
    def __init__(self, T_air, v_air, Tin, P, g, OD, ID, pipeLength, QSdot, t, k_insolation):
        ...
        # print('Tin ' + str(Tin - 273.15) + ' Tout = ' + str(self.Tout  - 273.15) + ' T_air = ' + str(T_air - 273.15))
...
if __name__ == "__main__":
    ...
    R = PipeLineHead(30 + 273.15, 10, 20 + 273.15, 7000, g, 0.4, 0.38, 20, 4000, .05, 100)
    print(R.Tout)
